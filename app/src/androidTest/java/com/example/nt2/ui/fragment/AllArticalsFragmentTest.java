...
public class AllArticalsFragmentTest {

//@Rule
//    public ActivityTestRule<AllArticalsFragment> allArticalsFragmentAllArticalsFragmentTest=new AllArticalsFragmentTest<>(AllArticalsFragment.class);
