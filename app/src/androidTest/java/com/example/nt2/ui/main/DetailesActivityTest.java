...
//
    ...
    public void fragment_can_be_instantiated() {
        ...
        onView(withId(R.id.fragment_detailes)).check(matches(isDisplayed()));
        onView(withId(R.id.source_artical)).check(matches(isDisplayed()));
        onView(withId(R.id.title_artical)).check(matches(isDisplayed()));
        onView(withId(R.id.body_artical)).check(matches(isDisplayed()));
    }
