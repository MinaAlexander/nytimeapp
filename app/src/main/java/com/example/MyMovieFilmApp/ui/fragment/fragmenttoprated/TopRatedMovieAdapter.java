...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.PostViewHolder> {
    private static String TAG = "PostsAdapter";
    private List<MovieModel> postList = new ArrayList<>();
    private TopRateFragment mOnClick;

    public TopRatedMovieAdapter(TopRateFragment mOnClick) {
...
//        holder.moveVote.setText(String.valueOf(postList.get(position).getGenre_ids()));
    ...
    public class PostViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        TopRateFragment onItemListener;
        RatingBar movie_ratingBar;

        public PostViewHolder(@NonNull View itemView, TopRateFragment onItemListener) {
            super(itemView);
