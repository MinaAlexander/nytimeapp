...
public class WatchNowMovieAdapter extends RecyclerView.Adapter<WatchNowMovieAdapter.PostViewHolder> {
    private static String TAG = "PostsAdapter";
    private List<MovieModel> postList = new ArrayList<>();
    private WatchNowFragment mOnClick;

    public WatchNowMovieAdapter(WatchNowFragment mOnClick) {
...
//        holder.moveVote.setText(String.valueOf(postList.get(position).getGenre_ids()));
    ...
    public class PostViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        WatchNowFragment onItemListener;
        RatingBar movie_ratingBar;

        public PostViewHolder(@NonNull View itemView, WatchNowFragment onItemListener) {
            super(itemView);
